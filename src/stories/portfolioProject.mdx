...
<Meta title="Type/PortfolioProject" />

# PortfolioProject

## Overview

The `PortfolioProject` type defines the structure for all portfolio data entries, ensuring consistency between cards, and modals.
